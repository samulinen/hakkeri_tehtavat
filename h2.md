...
Kopioin komennot tehtävänannosta komentokehotteeseen Debian12 virtuaalikoneellani. Testiympäristöön pääsin seuraamalla IP-osoitetta. Tunnilla kävimme läpi erään opiskelijan ratkaisut, joten tällä kertaa tiesin, mistä aloittaa. Laitettuani PIN koodiksi '123' sukelsin lähdekoodin pariin.
